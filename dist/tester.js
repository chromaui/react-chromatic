...
exports.default = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(_ref3) {
    ...
    var uri, client, _ref5, jwtToken, _ref6, commit, committedAt, committerEmail, committerName, branch, isTravisPrBuild, baselineCommits, appPathWithSlash, appUrl, child, isolatorUrl, tunnel, predicate, match, runtimeSpecs, fromCI, exitCode, _ref8, _ref8$createBuild, number, specCount, componentCount, webUrl, onlineHint, _ref9, status, buildAutoAcceptChanges, changeCount, errorCount, scriptCommand, confirmed;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 28:
            ...
            if (branch === 'HEAD') {
              ...
              branch = (0, _envCi2.default)().branch || process.env.BRANCH || branch;
            }
          ...
          case 95:
            ...
            _context2.t2 = status;
            _context2.next = _context2.t2 === 'BUILD_PASSED' ? 103 : _context2.t2 === 'BUILD_ACCEPTED' ? 106 : _context2.t2 === 'BUILD_PENDING' ? 106 : _context2.t2 === 'BUILD_DENIED' ? 106 : _context2.t2 === 'BUILD_FAILED' ? 110 : _context2.t2 === 'BUILD_TIMED_OUT' ? 113 : _context2.t2 === 'BUILD_ERROR' ? 116 : 119;
            break;
    ...
    }, _callee2, this, [[6, 14], [82, 122, 130, 136]]);
  }));
